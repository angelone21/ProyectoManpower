...
public class ControladorEmpleado {
    ...
    public Empleado consultar(String codigo) throws SQLException{
        ...
        PreparedStatement preparedStatement = conectarMySQL.getConnection().prepareStatement("select nombres,apellidos,fechanacimiento from empleado where cedula= ?");
    ...
    public void eliminar(Empleado empleado) throws SQLException{
        PreparedStatement preparedStatement = conectarMySQL.getConnection().prepareStatement("delete from empleado where cedula = ?");
        preparedStatement.setString(1,empleado.getCodigo());
        preparedStatement.execute();
    }
    
    public void eliminarTodo() throws SQLException{
        PreparedStatement preparedStatement = conectarMySQL.getConnection().prepareStatement("delete from empleado");
        preparedStatement.execute();
    }
}
